...
const headCells: HeadCell[] = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Name Event' },
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Tooltip title="Add Event">
          <IconButton aria-label="filter list" onClick={() => handleOpenAddEvent()}>
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} handleOpenAddEvent={handleOpenAddEvent}/>
        <TableContainer>
          <Table
